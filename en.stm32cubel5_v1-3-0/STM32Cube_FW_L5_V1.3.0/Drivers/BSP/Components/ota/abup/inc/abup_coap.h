 ...
 * @file        abup_coap.h
 *
 * @brief       The abup coap header file
 *
 * @revision
 * Date         Author          Notes
...
enum
{
    OPTION_MAP_SIZE = sizeof(abup_uint8) * 8
};
...
abup_extern coap_packet_t abup_coap_packet;
abup_extern abup_uint16   abup_current_msgid;

abup_extern void* abup_parse_message(abup_char* p, abup_int len);
abup_extern abup_uint8* abup_coap_para(abup_char* message, abup_int* data_len);
abup_extern abup_uint8* abup_coap_para_get(abup_int index, const abup_char* get, abup_int* data_len);
abup_extern abup_uint16 coap_get_msgid(void);
abup_extern void        coap_msgid_plus(void);
abup_extern void        abup_coap_packet_init(void);
abup_extern abup_uint16 abup_init_result_msg(abup_uint8* buf,
                                             abup_uint16 msgid,
                                             abup_uint8* token,
                                             abup_uint8  token_len);
abup_extern             abup_char*
                        abup_get_signptr(abup_char* mid, abup_char* productId, abup_char* productSecret, abup_uint32 utc_time);
abup_extern abup_char* abup_coap_make_data(abup_uint8 state, abup_uint para, abup_int* len);
...
abup_extern abup_uint   abup_coap_callback(abup_uint8 state, abup_char* data, abup_uint len);
abup_extern abup_bool   abup_legal_ID(abup_int32 mid, abup_int32 msgid);
abup_extern abup_char* abup_get_coap_server_host(void);
