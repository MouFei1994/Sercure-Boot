...
__root CK_RV SE_KMS_Initialize(CK_VOID_PTR pInitArgs)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_INITIALIZE_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status, pInitArgs);
...
__root CK_RV SE_KMS_Finalize(CK_VOID_PTR pReserved)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_FINALIZE_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status, pReserved);
...
__root CK_RV SE_KMS_GetInfo(CK_INFO_PTR   pInfo)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_GET_INFO_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status, pInfo);
                                ...
                                CK_ULONG_PTR pulCount)
{
  ...
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_GET_SLOT_LIST_FCT_ID,
                    (SE_StatusTypeDef *)&ck_rv_ret_status, tokenPresent, pSlotList, pulCount);
...
__root CK_RV SE_KMS_GetSlotInfo(CK_SLOT_ID slotID, CK_SLOT_INFO_PTR pInfo)
{
  ...
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_GET_SLOT_INFO_FCT_ID,
                    (SE_StatusTypeDef *)&ck_rv_ret_status,
                    slotID,
                    pInfo);
...
__root CK_RV SE_KMS_GetTokenInfo(CK_SLOT_ID slotID, CK_TOKEN_INFO_PTR pInfo)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_GET_TOKEN_INFO_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status, slotID,
                    pInfo);
                              ...
                              CK_ULONG ulPinLen,  CK_UTF8CHAR_PTR pLabel)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_INIT_TOKEN_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status, slotID, pPin,
                    ulPinLen, pLabel);
                                ...
                                CK_SESSION_HANDLE_PTR phSession)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_OPEN_SESSION_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
...
__root CK_RV SE_KMS_CloseSession(CK_SESSION_HANDLE hSession)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_CLOSE_SESSION_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status, hSession);
                                 ...
                                 CK_ULONG ulCount, CK_OBJECT_HANDLE_PTR phObject)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_CREATE_OBJECT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                  ...
                                  CK_OBJECT_HANDLE hObject)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DESTROY_OBJECT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession, hObject);
                                      ...
                                      CK_ATTRIBUTE_PTR pTemplate, CK_ULONG ulCount)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_GET_ATTRIBUTE_VALUE_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                      ...
                                      CK_ATTRIBUTE_PTR pTemplate, CK_ULONG ulCount)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_SET_ATTRIBUTE_VALUE_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession, hObject, pTemplate, ulCount);
                                    ...
                                    CK_ULONG ulCount)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_FIND_OBJECTS_INIT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                ...
                                CK_ULONG ulMaxObjectCount,  CK_ULONG_PTR pulObjectCount)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_FIND_OBJECTS_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
...
__root CK_RV SE_KMS_FindObjectsFinal(CK_SESSION_HANDLE hSession)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_FIND_OBJECTS_FINAL_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession);
                                ...
                                CK_MECHANISM_PTR  pMechanism, CK_OBJECT_HANDLE  hKey)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_ENCRYPT_INIT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                            ...
                            CK_ULONG_PTR      pulEncryptedDataLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_ENCRYPT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                  ...
                                  CK_ULONG_PTR      pulEncryptedPartLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_ENCRYPT_UPDATE_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                 ...
                                 CK_ULONG_PTR      pulLastEncryptedPartLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_ENCRYPT_FINAL_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                ...
                                CK_OBJECT_HANDLE  hKey)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DECRYPT_INIT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession, pMechanism, hKey);
                            ...
                            CK_ULONG_PTR pulDataLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DECRYPT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                  ...
                                  CK_ULONG_PTR      pulPartLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DECRYPT_UPDATE_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                 ...
                                 CK_ULONG_PTR      pulLastPartLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DECRYPT_FINAL_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
...
__root CK_RV SE_KMS_DigestInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DIGEST_INIT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession, pMechanism);
                           ...
                           CK_ULONG_PTR pulDigestLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DIGEST_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
...
__root CK_RV SE_KMS_DigestUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pPart, CK_ULONG ulPartLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DIGEST_UPDATE_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
...
__root CK_RV SE_KMS_DigestKey(CK_SESSION_HANDLE hSession, CK_OBJECT_HANDLE hKey)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DIGEST_KEY_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession, hKey);
                                ...
                                CK_ULONG_PTR pulDigestLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DIGEST_FINAL_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                             ...
                             CK_OBJECT_HANDLE  hKey)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_SIGN_INIT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession, pMechanism, hKey);
                         ...
                         CK_ULONG_PTR pulSignatureLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_SIGN_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                               ...
                               CK_OBJECT_HANDLE  hKey)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_VERIFY_INIT_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession, pMechanism, hKey);
                           ...
                           CK_ULONG  ulSignatureLen)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_VERIFY_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                    hSession, pData, ulDataLen,
...
__root CK_RV SE_KMS_ImportBlob(CK_BYTE_PTR pData, CK_ULONG_PTR pImportBlobState)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_IMPORT_BLOB_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                              ...
                              CK_ULONG  ulAttributeCount, CK_OBJECT_HANDLE_PTR  phKey)
{
  ...
  /*Secure Engine Call*/
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_DERIVE_KEY_FCT_ID, (SE_StatusTypeDef *)&ck_rv_ret_status,
                                    ...
                                    CK_OBJECT_HANDLE_PTR phPublicKey, CK_OBJECT_HANDLE_PTR phPrivateKey)
{
  ...
  (*SE_CallGatePtr)((SE_FunctionIDTypeDef)KMS_GENERATE_KEYPAIR_FCT_ID,
                    (SE_StatusTypeDef *)&ck_rv_ret_status, hSession,  pMechanism,
