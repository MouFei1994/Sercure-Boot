...
@par Directory contents
   ...
   - 1_Image_UserApp/Src/stm32f7xx_it.c           Interrupt handlers
   - 1_Image_UserApp/Src/system_stm32f7xx.c       STM32 system file
   ...
   - 1_Image_UserApp/Inc/stm32f7xx_conf.h         HAL configuration file
   - 1_Image_UserApp/Inc/stm32f7xx_it.h           Header for stm32f7xx_it.c file
...
2. Pressing 2 allows to test protections.
 ...
 - TAMPER test (#6): causes a reset if a tamper event is detected. In order to generate a tamper event,
   user has to connect PI8 (TP12) to GND (It may be enough to put your finger close to PI8 (TP12)).
