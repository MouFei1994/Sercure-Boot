...
SFU_IMG_InitStatusTypeDef SFU_IMG_CoreInit(void)
{
   ...
   */
  if ((SFU_LL_FLASH_GetSector(SFU_IMG_SLOT_1_REGION_BEGIN_VALUE)) <= SFU_PROTECT_WRP_PAGE_END_1)
  {
   ...
   */
  if ((SFU_LL_FLASH_GetSector(SFU_IMG_SWAP_REGION_BEGIN_VALUE)) <= SFU_PROTECT_WRP_PAGE_END_1)
  {
