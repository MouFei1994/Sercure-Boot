...
#define SE_CODE_REGION_ROM_END              (SE_STARTUP_REGION_ROM_START + 0x4FFF)
...
#define SB_REGION_ROM_END                   (SB_REGION_ROM_START + 0x77FF)
...
#define LOADER_REGION_ROM_END               0x0800FFFF
