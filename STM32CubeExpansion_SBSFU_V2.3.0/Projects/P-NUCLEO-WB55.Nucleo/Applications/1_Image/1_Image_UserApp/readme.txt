...
@par Directory contents
   ...
   - 1_Image_UserApp/Src/stm32wbxx_it.c           Interrupt handlers
   - 1_Image_UserApp/Src/system_stm32wbxx.c       STM32 system file
   ...
   - 1_Image_UserApp/Inc/stm32wbxx_conf.h         HAL configuration file
   - 1_Image_UserApp/Inc/stm32wbxx_it.h           Header for stm32wbxx_it.c file
...
2. Pressing 2 allows to test protections.
 ...
 - WRP test (#1): causes an error trying to erase write protected code
 ...
 - TAMPER test (#3): causes a reset if a tamper event is detected. In order to generate a tamper event,
   user has to connect PA0 (CN8.4) to GND (It may be enough to put your finger close to PA0 (CN8.4)).
