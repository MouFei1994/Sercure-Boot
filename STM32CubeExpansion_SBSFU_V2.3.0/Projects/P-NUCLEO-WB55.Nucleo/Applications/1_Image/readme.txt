...
This examples is provided with a single firmware image configuration in order to
maximize firmware image size. As a consequence, resume firmware update is not 
possible in case of power off during installations.
...
@par Directory contents
   ...
   - 1_Image_Loader     Standalone loader application
   - 1_Image_SECoreBin  Generate secure engine binary including all the "trusted" code
   - 1_Image_SBSFU      Secure boot and secure firmware update application
   - 1_Image_UserApp    Example of user application
...
0. Compile Loader application
The Loader binary is linked with the SBSFU code in step 2. 
