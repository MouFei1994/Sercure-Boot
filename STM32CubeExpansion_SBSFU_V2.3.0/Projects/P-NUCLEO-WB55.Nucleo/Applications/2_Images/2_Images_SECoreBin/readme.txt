...
@par Directory contents
   ...
   - 2_Images_SECoreBin/Binary/CKS_OEM_KEY_COMPANY1_key_AES_CBC.bin Public key for AES CBC encryption, formatted for provisioning into M0+ core
   - 2_Images_SECoreBin/Binary/CKS_OEM_KEY_COMPANY1_key_AES_GCM.bin Public key for AES GCM encryption, formatted for provisioning into M0+ core
...
1.  Access to Bootloader USB Interface (system flash) :
    ...
    - Connect USB cable to USB_USER interface
...
4.  You may update the key into key binary file with CKS header (first 2 bytes of CKS_OEM_KEY_COMPANY1_key_AES_GCM.bin)
