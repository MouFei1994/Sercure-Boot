...
ProtectionTest_t aProtectTests[] =
{
  ...
  {(uint32_t)(&DMA1_Channel1->CCR), "DMA1 channel 1 CCR", TEST_WRITE_RAM},
  {(uint32_t)(&DMA1_Channel7->CMAR), "DMA1 stream 7 CMAR", TEST_WRITE_RAM},
  {(uint32_t)(&DMA2_Channel1->CCR), "DMA2 channel 1 CCR", TEST_WRITE_RAM},
  {(uint32_t)(&DMA2_Channel7->CMAR), "DMA2 stream 7 CMAR", TEST_WRITE_RAM},
