...
@par Directory contents
   ...
   - 1_Image_UserApp/Src/stm32g4xx_it.c           Interrupt handlers
   - 1_Image_UserApp/Src/system_stm32g4xx.c       STM32 system file
   ...
   - 1_Image_UserApp/Inc/stm32g4xx_nucleo_conf.h  BSP configuration file   
   - 1_Image_UserApp/Inc/stm32g4xx_conf.h         HAL configuration file
   - 1_Image_UserApp/Inc/stm32g4xx_it.h           Header for stm32g4xx_it.c file
...
2. Pressing 2 allows to test protections.
 ...
 - TAMPER test (#3): causes a reset if a tamper event is detected. In order to generate a tamper event,
   user has to connect PA0 (CN11.1) to GND (It may be enough to put your finger close to PA0 (CN11.1)).
