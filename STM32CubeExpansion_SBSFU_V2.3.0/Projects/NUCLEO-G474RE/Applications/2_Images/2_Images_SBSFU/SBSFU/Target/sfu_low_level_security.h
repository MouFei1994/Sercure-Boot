...
/** @defgroup SFU_CONFIG_SEC_MEM Secure Memory Configuration
  * @brief In the STM32G0xx, Secure Memory is configured from FLASH_BASE to Slot0 header (included)
  * @{
  */
#define SFU_NB_PAGE_SEC_USER_MEM ((uint32_t)(((SFU_SEC_MEM_AREA_ADDR_END - FLASH_BASE) / FLASH_PAGE_SIZE_128_BITS) + 1))
...
#define SFU_PROTECT_WRP_PAGE_END_1      ((uint32_t)((SFU_AREA_ADDR_END - FLASH_BASE) / FLASH_PAGE_SIZE_128_BITS))
...
#define SFU_PROTECT_MPU_PERIPH_2_SIZE  MPU_REGION_SIZE_4KB
#define SFU_PROTECT_MPU_PERIPH_2_SREG  0xC0U               /*!< 4 Kbytes / 8 * 6 ==> 3 Kbytes */
