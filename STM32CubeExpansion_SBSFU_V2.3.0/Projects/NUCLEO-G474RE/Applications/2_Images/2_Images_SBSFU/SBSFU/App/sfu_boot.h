...
/**
  ...
  */
#define FLOW_CTRL_IWDG (FLOW_CTRL_STATIC_PROTECT ^ FLOW_STEP_IWDG)
#define FLOW_CTRL_MPU (FLOW_CTRL_IWDG ^ FLOW_STEP_MPU)
#define FLOW_CTRL_FWALL (FLOW_CTRL_MPU ^ FLOW_STEP_FWALL)
#define FLOW_CTRL_DMA (FLOW_CTRL_FWALL ^ FLOW_STEP_DMA)
#define FLOW_CTRL_DAP (FLOW_CTRL_DMA ^ FLOW_STEP_DAP)
