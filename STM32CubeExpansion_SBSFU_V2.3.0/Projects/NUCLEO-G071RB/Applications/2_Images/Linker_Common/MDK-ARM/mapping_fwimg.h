...
#define REGION_SWAP_START                   0x08017000
#define REGION_SWAP_END                     0x08017FFF

/* slot 0 region (28 kbytes) */
#define REGION_SLOT_0_START                 0x08010000
#define REGION_SLOT_0_END                   0x08016FFF

/* slot 1 region (28 kbytes) */
#define REGION_SLOT_1_START                 0x08018000
#define REGION_SLOT_1_END                   0x0801EFFF
