...
/** @defgroup SFU_CONFIG_SEC_MEM Secure Memory Configuration
  ...
  * @{
  */
#define SFU_NB_PAGE_SEC_USER_MEM ((uint32_t)(((SFU_SEC_MEM_AREA_ADDR_END - FLASH_BASE) / FLASH_PAGE_SIZE) + 1))
...
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0x80U               /*!< 64 Kbytes / 8 * 7 ==> 56 Kbytes */
#else
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0xC0U               /*!< 64 Kbytes / 8 * 6 ==> 48 Kbytes */
#endif /* __GNUC__ */
