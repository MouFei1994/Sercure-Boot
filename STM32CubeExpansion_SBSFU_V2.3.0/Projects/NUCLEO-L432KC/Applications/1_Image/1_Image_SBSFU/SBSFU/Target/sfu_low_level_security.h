...
#define SFU_PROTECT_FWALL_CODE_SIZE         ((uint32_t) SFU_SENG_AREA_SIZE)      /*!< Firewall protection CODE area 
                                                                                      SIZE*/
#define SFU_PROTECT_FWALL_NVDATA_ADDR_START (SFU_IMG_SLOT_0_REGION_HEADER_VALUE)  /*!< Firewall protection NVDATA area 
                                                                                      START address*/
...
/**
  ...
  */
/**
  * Region definition : from 0x0801 0000 ==> 0x0804 0000
  */
#define APP_PROTECT_MPU_AREA_SLOT0_START        FLASH_BASE                   /*!< Flash memory area */
#define APP_PROTECT_MPU_AREA_SLOT0_SIZE         MPU_REGION_SIZE_256KB
...
#define APP_PROTECT_MPU_AREA_SLOT0_SREG         0x03U                        /*!< 256 Kbytes / 8 * 6 ==> 192 Kbytes */
