...
@par Directory contents
   ...
   - 1_Image_SBSFU/Core/Src/stm32l4xx_hal_msp.c              HAL MSP module
   - 1_Image_SBSFU/Core/Src/stm32l4xx_it.c                   STM32 interrupt handlers   
   - 1_Image_SBSFU/Core/Inc/app_hw.h                         Hardware definition for application
   - 1_Image_SBSFU/Core/Inc/main.h                           Header file for main.c
   - 1_Image_SBSFU/Core/Inc/stm32l4xx_hal_conf.h             HAL configuration file   
   - 1_Image_SBSFU/Core/Inc/stm32l4xx_it.h                   Header file for stm32l4xx_it.c
...
@par Hardware and Software environment
  ...
  - STM32L432KC-Nucleo RevC set-up : connect PA.12 (Arduino D2) to GND with a jumper.
...
Note1 : Remove the jumper between PA.12 (Arduino D2) and GND to force a local
