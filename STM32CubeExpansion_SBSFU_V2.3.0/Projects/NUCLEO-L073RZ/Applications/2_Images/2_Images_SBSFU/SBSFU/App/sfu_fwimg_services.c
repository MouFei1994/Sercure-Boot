...
SFU_ErrorStatus SFU_IMG_InvalidateCurrentFirmware(void)
{
  ...
  e_ret_status = SFU_LL_FLASH_Erase_Size(&x_flash_info, SFU_IMG_SLOT_0_REGION_BEGIN + SFU_IMG_IMAGE_OFFSET,
...
SFU_ErrorStatus SFU_IMG_LaunchActiveImg(void)
{
  ...
  /* Configure Slot0 area in execution mode if required (external flash) */
  SFU_LL_FLASH_Config_Exe(SFU_IMG_SLOT_0_REGION_BEGIN_VALUE);
