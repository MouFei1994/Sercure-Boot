...
#define SFU_PROTECT_FWALL_CODE_SIZE         ((uint32_t) SFU_SENG_AREA_SIZE)      /*!< Firewall protection CODE area 
                                                                                      SIZE*/
#define SFU_PROTECT_FWALL_NVDATA_ADDR_START ((uint32_t) FLASH_BANK2_BASE)        /*!< Firewall protection NVDATA area 
                                                                                      START address*/
#define SFU_PROTECT_FWALL_NVDATA_SIZE       (SFU_IMG_SLOT_0_REGION_HEADER_VALUE + SFU_IMG_IMAGE_OFFSET - \
...
/*
 * L0xx
 * [ 1FF80000 ... 1FF80020]: 32 bytes to be protected
 ...
 * Here, we define a 256B region (minimal region size for Cortex®-M0+) so
 * subregions can be used.
 */
#define SFU_PROTECT_MPU_AREA_OB_BANK1_START     ((uint32_t)0x1FF80000U)       /*!< Option Bytes memory area */
...
#define SFU_PROTECT_MPU_AREA_OB_BANK1_SREG      0xFEU                         /*!< 256 bytes / 8 * 1 ==> 32 bytes */
...
/**
  ...
  */
/**
  * Region definition : from 0x0802 0000 ==> 0x0802 A000
  * Remove execution capability from 0x0802 9000 ==> 0x0802 A000 with region 7
  */
#define APP_PROTECT_MPU_AREA_SLOT0_START        SFU_IMG_SLOT_0_REGION_BEGIN_VALUE
#define APP_PROTECT_MPU_AREA_SLOT0_SIZE         MPU_REGION_SIZE_64KB
...
#define APP_PROTECT_MPU_AREA_SLOT0_SREG         0xE0U                        /*!< 64 Kbytes / 8 * 5 ==> 40 Kbytes */

#define APP_PROTECT_MPU_AREA_HIDE_START        (SFU_IMG_SLOT_0_REGION_BEGIN_VALUE + SFU_IMG_SLOT_0_REGION_SIZE)
#define APP_PROTECT_MPU_AREA_HIDE_SIZE         MPU_REGION_SIZE_4KB
...
#define APP_PROTECT_MPU_AREA_HIDE_SREG         0x00U                         /*!< All subregions activated */
