...
static void TEST_PROTECTIONS_Run_CORRUPT_IMAGE(void)
{
  ...
  /* On this series, the memory corruption is performed by erasing flash page (but not header).
     The header is preserved for anti-rollback check. */
  ret = FLASH_If_Erase_Size((void *)(TEST_PROTECTIONS_CORRUPT_IMAGE_FLASH_ADDRESS),
                            TEST_PROTECTIONS_CORRUPT_IMAGE_FLASH_SIZE);
...
static void TEST_PROTECTIONS_Run_TAMPER(void)
{
  ...
  /* Print instructions*/
  printf("  -- Pull PA0 (CN8.1) to GND \r\n\n");
  printf("  -- -- Note: sometimes it may be enough to put your finger close to PA0 (CN8.1)\r\n\n");
