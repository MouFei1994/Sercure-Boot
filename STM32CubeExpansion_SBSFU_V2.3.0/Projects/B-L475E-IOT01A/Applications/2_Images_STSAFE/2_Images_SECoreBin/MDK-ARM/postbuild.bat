...
set "fw_sign_ecckey=%SBSFUBootLoader%\\2_Images_SBSFU\\Certs\\STM-POC-SBSFU-FW-SIGNING-TEST\\private\\STM-POC-SBSFU-FW-SIGNING-TEST-00_private_key.pem"
set "sbsfuelf=%SBSFUBootLoader%\\2_Images_SBSFU\\MDK-ARM\\B-L475E-IOT01_2_Images_SBSFU\\SBSFU.axf"
set "cert_fw_leaf=%SBSFUBootLoader%\\2_Images_SBSFU\\Certs\\STM-POC-SBSFU-FW-SIGNING-TEST\\certs\\STM-POC-SBSFU-FW-SIGNING-TEST-00.pem"
set "cert_fw_inter=%SBSFUBootLoader%\\2_Images_SBSFU\\Certs\\STM-POC-SBSFU-OEM-INTMD-TEST-CA\\certs\\STM-POC-SBSFU-OEM-INTMD-TEST-CA-00.pem"
