...
One cryptographic scheme (SECBOOT_X509_ECDSA_WITHOUT_ENCRYPT_SHA256) is provided as example to illustrate 
the cryptographic operations. This cryptographic scheme uses Certificates (X509) and asymmetric (ECDSA) 
cryptography.
