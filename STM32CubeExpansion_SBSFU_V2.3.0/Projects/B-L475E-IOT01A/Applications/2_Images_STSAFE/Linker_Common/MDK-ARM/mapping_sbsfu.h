...
#define SE_CODE_REGION_ROM_END              (SE_STARTUP_REGION_ROM_START + 0x111FF)
...
#define SB_REGION_ROM_END                   0x08025FFF
...
#define KMS_DATASTORAGE_START               0x08080800
#define KMS_DATASTORAGE_END                 0x080837FF
...
#define SE_REGION_RAM_STACK_TOP           0x20000700
#define SE_REGION_RAM_END                 0x20004FFF

/* SBSFU RAM1 region */
#define SB_REGION_RAM_START               (SE_REGION_RAM_END + 0x01)
#define SB_REGION_RAM_END                 0x20017FFF
