...
#define  SE_Encrypt_Init( peSE_Status, pxSE_Metadata, SE_FwType ) \
  SFU_Encrypt_Init( peSE_Status, pxSE_Metadata, SE_FwType )

#define SE_Encrypt_Append( peSE_Status, pInputBuffer, InputSize, pOutputBuffer, pOutputSize ) \
  SFU_Encrypt_Append( peSE_Status, pInputBuffer, InputSize, pOutputBuffer, pOutputSize )

#define SE_Encrypt_Finish( peSE_Status, pOutputBuffer, pOutputSize ) \
  SFU_Encrypt_Finish( peSE_Status, pOutputBuffer, pOutputSize )
...
#define SE_VerifyFwRawHeaderTag( peSE_Status, pxFwRawHeader ) \
  SFU_VerifyFwRawHeaderTag( peSE_Status, pxFwRawHeader )
