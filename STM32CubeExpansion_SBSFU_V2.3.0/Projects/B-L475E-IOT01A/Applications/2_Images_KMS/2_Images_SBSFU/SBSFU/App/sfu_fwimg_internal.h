...
#define SLOT_0_HDR (( uint8_t *)(SFU_IMG_SLOT_0_REGION_HEADER))
/** Header position in slot #1 */
#define SLOT_1_HDR (( uint8_t *)(SFU_IMG_SLOT_1_REGION_HEADER))
...
/**
  ...
  */
const uint32_t  SlotHeaderAddress[SFU_SLOTS ] = { SFU_IMG_SLOT_0_REGION_HEADER_VALUE,
                                                  SFU_IMG_SLOT_1_REGION_HEADER_VALUE,
                                                  SFU_IMG_SWAP_REGION_BEGIN_VALUE
                                                };
const uint32_t  SlotBeginAddress[SFU_SLOTS ]  = { SFU_IMG_SLOT_0_REGION_BEGIN_VALUE,
...
/* CleanUp slot (write empty values) */
