...
This examples is provided with a dual firmware image configuration in order 
...
Cryptographic services are delivered as open source code. It can be configured 
to use asymmetric or symmetric cryptographic schemes with or without firmware 
encryption.
