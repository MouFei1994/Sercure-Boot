...
ProtectionTest_t aProtectTests[] =
{
  ...
  /*
   * L152
   * 0x1FF8 0000 Reserved RDP & sector protection
   * 0x1FF8 0004 User option bytes (USER)
   * 0x1FF8 0008 Reserved Write protection for sectors 0 to 15
   * 0x1FF8 000C Reserved Write protection for sectors 16 to 31
   * 0x1FF8 0010 Reserved Write protection for sectors 32 to 47
   * 0x1FF8 0014 Reserved Write protection for sectors 48 to 63
   * 0x1FF8 0018 Reserved Write protection for sectors 64 to 79
   * 0x1FF8 001C Reserved Write protection for sectors 80 to 95
   * 0x1FF8 0080 Reserved Write protection for sectors 96 to 111
   * 0x1FF8 0084 Reserved Write protection for sectors 112 to 127
   */
  {(uint32_t)0x1FF80000, "OBs @ 0x1FF80000", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF80004, "OBs @ 0x1FF80004", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF80008, "OBs @ 0x1FF80008", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF8000C, "OBs @ 0x1FF8000C", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF80010, "OBs @ 0x1FF80010", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF80014, "OBs @ 0x1FF80014", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF80018, "OBs @ 0x1FF80018", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF8001C, "OBs @ 0x1FF8001C", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF80080, "OBs @ 0x1FF80080", TEST_WRITE_FLASH},
  {(uint32_t)0x1FF80084, "OBs @ 0x1FF80084", TEST_WRITE_FLASH},
#endif /* SFU_MPU_PROTECT_ENABLE  */
  ...
  do
  {
    ...
    switch (aProtectTests[test_idx].type)
    {
      ...
      case TEST_ERASE_FLASH :
        ...
        p_erase_init.PageAddress = aProtectTests[test_idx].address;
