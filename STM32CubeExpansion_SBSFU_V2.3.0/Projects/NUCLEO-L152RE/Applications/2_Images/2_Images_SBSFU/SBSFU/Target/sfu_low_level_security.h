...
/**
  * @brief Region 0 - Enable the read/write operations for full peripheral area area (without bit banding region) in
  *                   unprivileged mode.
...
#define SFU_PROTECT_MPU_PERIPH_2_START DMA1_BASE           /*!< DMA peripheral memory area */
...
#define SFU_PROTECT_MPU_SRAMACC_SREG  0xE0U                /*!< 128 Kbytes / 8 * 5 => 80 Kbytes */
...
#define APP_PROTECT_MPU_PERIPH_1_SIZE  MPU_REGION_SIZE_256MB
#define APP_PROTECT_MPU_PERIPH_1_SREG  0x00U
...
#define APP_PROTECT_MPU_FLASHEXE_SREG  0xF0U               /*!< 512 Kbytes / 8 * 4 ==> 256 Kbytes */
...
#define APP_PROTECT_MPU_DMABBA_START (PERIPH_BB_BASE  + (DMA1_BASE - PERIPH_BASE) * 32U )
