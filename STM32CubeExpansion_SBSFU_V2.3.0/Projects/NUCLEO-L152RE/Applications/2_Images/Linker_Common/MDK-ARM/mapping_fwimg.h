...
#define REGION_SWAP_START                   0x08070000
#define REGION_SWAP_END                     0x08070FFF

/* slot 0 region (192 kbytes) */
#define REGION_SLOT_0_START                 0x08010000
#define REGION_SLOT_0_END                   0x0803FFFF

/* slot 1 region (192 kbytes) */
#define REGION_SLOT_1_START                 0x08040000
#define REGION_SLOT_1_END                   0x0806FFFF
