...
@par Directory contents
   ...
   - 2_Images_UserApp/Src/stm32l1xx_it.c           Interrupt handlers
   - 2_Images_UserApp/Src/system_stm32l1xx.c       STM32 system file
   ...
   - 2_Images_UserApp/Inc/stm32l1xx_conf.h         HAL configuration file
   - 2_Images_UserApp/Inc/stm32l1xx_it.h           Header for stm32l1xx_it.c file
...
2. Pressing 2 allows to test protections.
 ...
 - TAMPER test (#6): causes a reset if a tamper event is detected. In order to generate a tamper event,
   user has to connect PA0 (CN8.1) to GND (It may be enough to put your finger close to PA0 (CN8.1)).
