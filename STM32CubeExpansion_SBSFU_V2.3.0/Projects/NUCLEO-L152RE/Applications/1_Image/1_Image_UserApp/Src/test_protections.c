...
/** @defgroup  TEST_PROTECTIONS_Private_Functions Private Functions
  * @{
  */
static void TEST_PROTECTIONS_Run_SE_CODE(void);
static void TEST_PROTECTIONS_Run_SE_VDATA(void);
...
void TEST_PROTECTIONS_Run(void)
{
  ...
  while (exit == 0U)
  {
    ...
    if (COM_Receive(&key, 1U, RX_TIMEOUT) == HAL_OK)
    {
      ...
      {
        case '1' :
          TEST_PROTECTIONS_Run_SE_CODE();
          break;
        case '2' :
          TEST_PROTECTIONS_Run_SE_VDATA();
          break;
        case '3' :
...
{
  printf("\r\n=================== Test Menu ============================\r\n\n");
  printf("  Test SE isolation - CODE ------------------------------ 1\r\n\n");
  printf("  Test SE isolation - VDATA ----------------------------- 2\r\n\n");
