...
@par Directory contents
   ...
   - 2_Images_UserApp/Src/stm32h7xx_it.c           Interrupt handlers
   - 2_Images_UserApp/Src/system_stm32h7xx.c       STM32 system file
   ...
   - 2_Images_UserApp/Inc/stm32h7b3i_discovery_conf.h BSP configuration file   
   - 2_Images_UserApp/Inc/sfu_app_new_image.h      Header file for sfu_app_new_image.c
   - 2_Images_UserApp/Inc/stm32h7xx_conf.h         HAL configuration file
   - 2_Images_UserApp/Inc/stm32h7xx_it.h           Header for stm32h7xx_it.c file
...
2. Pressing 2 allows to test protections.
 ...
 - Secure user memory protection test (#1): cause an error trying to access protected code
 - IWDG test (#2): causes a reset simulating a deadlock by not refreshing the watchdog
 - TAMPER test (#3): TAMPER protection is not activated on this board due to conflict with USER button
 - CORRUPT IMAGE test (#4): not possible to corrupt external FLASH during UserApp execution. Write and 
   erase flash commands are not allowed in memory map mode configuration.
