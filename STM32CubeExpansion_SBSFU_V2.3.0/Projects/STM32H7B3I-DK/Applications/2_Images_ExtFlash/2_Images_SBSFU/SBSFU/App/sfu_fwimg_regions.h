 ...
 */
#define SFU_IMG_SLOT_0_REGION_HEADER_VALUE ((uint32_t) REGION_SLOT_0_HEADER)
#define SFU_IMG_SLOT_0_REGION_HEADER ((uint8_t *)REGION_SLOT_0_HEADER)
...
#define SFU_IMG_SLOT_1_REGION_HEADER_VALUE ((uint32_t)REGION_SLOT_1_START)
#define SFU_IMG_SLOT_1_REGION_HEADER ((uint8_t *)REGION_SLOT_1_START)
