...
#define SFU_PROTECT_WRP_PAGE_START_1    ((uint32_t)((SFU_BOOT_BASE_ADDR - FLASH_BASE) / (FLASH_SECTOR_SIZE*4)))

/*!< Last sector: (code_size-1)/sector_size because the
     page indexes start from 0 */
#define SFU_PROTECT_WRP_PAGE_END_1      ((uint32_t)((SFU_AREA_ADDR_END - FLASH_BASE) / (FLASH_SECTOR_SIZE*4)))
...
#define SFU_PROTECT_MPU_PERIPH_2_START SRD_AHB4PERIPH_BASE
#define SFU_PROTECT_MPU_PERIPH_2_SIZE  MPU_REGION_SIZE_32KB
#define SFU_PROTECT_MPU_PERIPH_2_SREG  0xE0U               /*!< 5 subregions activated */
...
/**
  * @brief Region 8 - Enable the read/write operations for the 1st APB4 peripheral in unprivileged mode.
  *                   Execution capability disabled
  */
#define SFU_PROTECT_MPU_PERIPH_3_RGNV  MPU_REGION_NUMBER8
#define SFU_PROTECT_MPU_PERIPH_3_START SRD_APB4PERIPH_BASE      /*!< APB4 Peripheral memory area */
#define SFU_PROTECT_MPU_PERIPH_3_SIZE  MPU_REGION_SIZE_32KB
#define SFU_PROTECT_MPU_PERIPH_3_SREG  0x00U               /*!< All subregions activated */
#define SFU_PROTECT_MPU_PERIPH_3_PERM  MPU_REGION_FULL_ACCESS
#define SFU_PROTECT_MPU_PERIPH_3_EXECV MPU_INSTRUCTION_ACCESS_DISABLE
#define SFU_PROTECT_MPU_PERIPH_3_TEXV  MPU_TEX_LEVEL0
#define SFU_PROTECT_MPU_PERIPH_3_B     MPU_ACCESS_BUFFERABLE
#define SFU_PROTECT_MPU_PERIPH_3_C     MPU_ACCESS_NOT_CACHEABLE

/**
  * @brief Region 9 - Enable all read/write operations for CRC peripheral.
  *                   Execution capability disabled
  */
#define SFU_PROTECT_MPU_CRC_RGNV  MPU_REGION_NUMBER9
#define SFU_PROTECT_MPU_CRC_START CRC_BASE               /*!< CRC peripheral memory area */
#define SFU_PROTECT_MPU_CRC_SIZE  MPU_REGION_SIZE_1KB
#define SFU_PROTECT_MPU_CRC_SREG  0x00U                  /*!< All subregions activated */
#define SFU_PROTECT_MPU_CRC_PERM  MPU_REGION_FULL_ACCESS
#define SFU_PROTECT_MPU_CRC_EXECV MPU_INSTRUCTION_ACCESS_DISABLE
#define SFU_PROTECT_MPU_CRC_TEXV  MPU_TEX_LEVEL0
#define SFU_PROTECT_MPU_CRC_B     MPU_ACCESS_BUFFERABLE
#define SFU_PROTECT_MPU_CRC_C     MPU_ACCESS_NOT_CACHEABLE

/**
  * @brief Region 10 - Enable all read/write operations for FLASH peripheral.
  *                    Execution capability disabled
  */
#define SFU_PROTECT_MPU_FLASH_RGNV  MPU_REGION_NUMBER10
#define SFU_PROTECT_MPU_FLASH_START FLASH_R_BASE           /*!< FLASH peripheral memory area */
#define SFU_PROTECT_MPU_FLASH_SIZE  MPU_REGION_SIZE_4KB
#define SFU_PROTECT_MPU_FLASH_SREG  0x00U                  /*!< All subregions activated */
#define SFU_PROTECT_MPU_FLASH_PERM  MPU_REGION_FULL_ACCESS
#define SFU_PROTECT_MPU_FLASH_EXECV MPU_INSTRUCTION_ACCESS_DISABLE
#define SFU_PROTECT_MPU_FLASH_TEXV  MPU_TEX_LEVEL0
#define SFU_PROTECT_MPU_FLASH_B     MPU_ACCESS_BUFFERABLE
#define SFU_PROTECT_MPU_FLASH_C     MPU_ACCESS_NOT_CACHEABLE

/**
  * @brief Region 11 - Enable all read/write operations for OCTOSPI peripheral.
  *                    Execution capability disabled
  */
#define SFU_PROTECT_MPU_OSPI_RGNV  MPU_REGION_NUMBER11
#define SFU_PROTECT_MPU_OSPI_START OCTOSPI1_R_BASE        /*!< OCTOSPI peripheral memory area */
#define SFU_PROTECT_MPU_OSPI_SIZE  MPU_REGION_SIZE_4KB
#define SFU_PROTECT_MPU_OSPI_SREG  0x00U                  /*!< All subregions activated */
#define SFU_PROTECT_MPU_OSPI_PERM  MPU_REGION_FULL_ACCESS
#define SFU_PROTECT_MPU_OSPI_EXECV MPU_INSTRUCTION_ACCESS_DISABLE
#define SFU_PROTECT_MPU_OSPI_TEXV  MPU_TEX_LEVEL0
#define SFU_PROTECT_MPU_OSPI_B     MPU_ACCESS_BUFFERABLE
#define SFU_PROTECT_MPU_OSPI_C     MPU_ACCESS_NOT_CACHEABLE

/**
  * @brief Region 12 - Enable all read/write operations for OTFDEC peripherals.
  *                    Execution capability disabled
  */
#define SFU_PROTECT_MPU_OTFDEC_RGNV  MPU_REGION_NUMBER12
#define SFU_PROTECT_MPU_OTFDEC_START OTFDEC1_BASE           /*!< OTFDEC peripheral memory area */
#define SFU_PROTECT_MPU_OTFDEC_SIZE  MPU_REGION_SIZE_1KB
#define SFU_PROTECT_MPU_OTFDEC_SREG  0x00U                  /*!< All subregions activated */
#define SFU_PROTECT_MPU_OTFDEC_PERM  MPU_REGION_FULL_ACCESS
#define SFU_PROTECT_MPU_OTFDEC_EXECV MPU_INSTRUCTION_ACCESS_DISABLE
#define SFU_PROTECT_MPU_OTFDEC_TEXV  MPU_TEX_LEVEL0
#define SFU_PROTECT_MPU_OTFDEC_B     MPU_ACCESS_BUFFERABLE
#define SFU_PROTECT_MPU_OTFDEC_C     MPU_ACCESS_NOT_CACHEABLE
...
#define SFU_CALLBACK_ANTITAMPER(void) HAL_RTCEx_Tamper1EventCallback(RTC_HandleTypeDef *hrtc)
