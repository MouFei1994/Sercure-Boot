...

{
  ...
  /*  peripheral  */
  , {
    SFU_PROTECT_MPU_PERIPH_3_RGNV, SFU_PROTECT_MPU_PERIPH_3_START, SFU_PROTECT_MPU_PERIPH_3_SIZE,
    SFU_PROTECT_MPU_PERIPH_3_PERM, SFU_PROTECT_MPU_PERIPH_3_EXECV, SFU_PROTECT_MPU_PERIPH_3_SREG,
    SFU_PROTECT_MPU_PERIPH_3_TEXV, SFU_PROTECT_MPU_PERIPH_3_C, SFU_PROTECT_MPU_PERIPH_3_B
  },
  {
    SFU_PROTECT_MPU_CRC_RGNV, SFU_PROTECT_MPU_CRC_START, SFU_PROTECT_MPU_CRC_SIZE,
    SFU_PROTECT_MPU_CRC_PERM, SFU_PROTECT_MPU_CRC_EXECV, SFU_PROTECT_MPU_CRC_SREG,
    SFU_PROTECT_MPU_CRC_TEXV, SFU_PROTECT_MPU_CRC_C, SFU_PROTECT_MPU_CRC_B
  },
  {
    SFU_PROTECT_MPU_FLASH_RGNV, SFU_PROTECT_MPU_FLASH_START, SFU_PROTECT_MPU_FLASH_SIZE,
    SFU_PROTECT_MPU_FLASH_PERM, SFU_PROTECT_MPU_FLASH_EXECV, SFU_PROTECT_MPU_FLASH_SREG,
    SFU_PROTECT_MPU_FLASH_TEXV, SFU_PROTECT_MPU_FLASH_C, SFU_PROTECT_MPU_FLASH_B
  },
  {
    SFU_PROTECT_MPU_OSPI_RGNV, SFU_PROTECT_MPU_OSPI_START, SFU_PROTECT_MPU_OSPI_SIZE,
    SFU_PROTECT_MPU_OSPI_PERM, SFU_PROTECT_MPU_OSPI_EXECV, SFU_PROTECT_MPU_OSPI_SREG,
    SFU_PROTECT_MPU_OSPI_TEXV, SFU_PROTECT_MPU_OSPI_C, SFU_PROTECT_MPU_OSPI_B
  },
  {
    SFU_PROTECT_MPU_OTFDEC_RGNV, SFU_PROTECT_MPU_OTFDEC_START, SFU_PROTECT_MPU_OTFDEC_SIZE,
    SFU_PROTECT_MPU_OTFDEC_PERM, SFU_PROTECT_MPU_OTFDEC_EXECV, SFU_PROTECT_MPU_OTFDEC_SREG,
    SFU_PROTECT_MPU_OTFDEC_TEXV, SFU_PROTECT_MPU_OTFDEC_C, SFU_PROTECT_MPU_OTFDEC_B
  }
...
SFU_ErrorStatus SFU_LL_SECU_CheckApplyStaticProtections(void)
{
...
#ifdef SFU_SECURE_USER_PROTECT_ENABLE
    if (SFU_LL_RSS_CheckProtectionSecUser(&flash_option_bytes) != SFU_SUCCESS)
    {
      TRACE("\r\n= [SBOOT] System Security Configuration failed! Product blocked.");
      /* Security issue : execution stopped ! */
      SFU_EXCPT_Security_Error();
  ...
  else
  {
    ...
    if (e_ret_status == SFU_SUCCESS)
    {
      e_ret_status = SFU_LL_RSS_SetProtectionSecUser(&flash_option_bytes, &is_protection_to_be_applied);
    }
#endif  /* SFU_SECURE_USER_PROTECT_ENABLE */
...
SFU_ErrorStatus SFU_LL_SECU_CheckProtectionWRP(FLASH_OBProgramInitTypeDef *psFlashOptionBytes)
{
  ...
  {
    if ((psFlashOptionBytes->WRPSector & (OB_WRP_SECTOR_0TO3 << i)) != (OB_WRP_SECTOR_0TO3 << i))
    {
                                             ...
                                             SFU_BoolTypeDef *pbIsProtectionToBeApplied)
{
  ...
  else
  {
    ...
    for (uint32_t i = SFU_PROTECT_WRP_PAGE_START_1; i <= SFU_PROTECT_WRP_PAGE_END_1; i++)
    {
      psFlashOptionBytes->WRPSector |= (OB_WRP_SECTOR_0TO3 << i);
    }
