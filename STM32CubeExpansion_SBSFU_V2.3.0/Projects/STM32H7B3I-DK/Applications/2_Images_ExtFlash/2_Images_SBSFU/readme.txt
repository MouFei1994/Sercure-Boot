...
In this example slots are located in external flash. OTFDEC (On The Fly Decryption) is configured 
to execute the encrypted (AES CTR) user application from external flash.
...
@par Directory contents
   ...
   - 2_Images_SBSFU/Core/Src/stm32h7xx_hal_msp.c              HAL MSP module
   - 2_Images_SBSFU/Core/Src/stm32h7xx_it.c                   STM32 interrupt handlers   
   ...
   - 2_Images_SBSFU/Core/Inc/stm32h7b3i_discovery_conf.h      BSP configuration file   
   - 2_Images_SBSFU/Core/Inc/stm32h7xx_hal_conf.h             HAL configuration file   
   - 2_Images_SBSFU/Core/Inc/stm32h7xx_it.h                   Header file for stm32h7xx_it.c
   ...
   - 2_Images_SBSFU/SBSFU/Target/sfu_low_level_security_rss.c SBSFU Root Secure Services low level interface
   ...
   - 2_Images_SBSFU/SBSFU/Target/sfu_low_level_security_rss.h Header file for RSS low level interface
