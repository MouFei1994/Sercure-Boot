...
extern uint32_t __ICFEDIT_bank1_secure_start__;
#define BANK1_SECURE_START ((uint32_t)& __ICFEDIT_bank1_secure_start__)
extern uint32_t __ICFEDIT_bank1_secure_end__;
#define BANK1_SECURE_END ((uint32_t)& __ICFEDIT_bank1_secure_end__)
...
extern uint32_t __ICFEDIT_region_SLOT_0_header__;
#define REGION_SLOT_0_HEADER ((uint32_t)& __ICFEDIT_region_SLOT_0_header__)
