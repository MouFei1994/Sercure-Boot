...
#define CHUNK_SIZE_SIGN_VERIFICATION (256U)  /*!< Signature verification chunk size*/
...
static  uint8_t decrypted_sector[FLASH_PAGE_SIZE] __attribute__((aligned(4)));
...
static SFU_ErrorStatus DecryptImageInSlot0(SE_FwRawHeaderTypeDef *pFwImageHeader)
{
  ...
  uint32_t NumberOfChunkPerSector = FLASH_PAGE_SIZE / SFU_IMG_CHUNK_SIZE;
