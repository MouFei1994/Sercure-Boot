...
/* Aligned SE End at the end of the 1st 20 Kbytes of flash, MPU protection isolation constraints */
#define SE_CODE_REGION_ROM_END              0x08004FFF
...
#define SB_REGION_ROM_END                   0x08009FFF
...
#define SE_REGION_RAM_END                 0x20000DFF

/* SBSFU RAM1 region */
#define SB_REGION_RAM_START               (SE_REGION_RAM_END + 0x1)
#define SB_REGION_RAM_END                 0x20001FFF
