...

{
  ...
  , {
    SFU_PROTECT_MPU_DMA2D_RGNV, SFU_PROTECT_MPU_DMA2D_START, SFU_PROTECT_MPU_DMA2D_SIZE,
    SFU_PROTECT_MPU_DMA2D_PERM, SFU_PROTECT_MPU_DMA2D_EXECV, SFU_PROTECT_MPU_DMA2D_SREG,
    SFU_PROTECT_MPU_DMA2D_TEXV, SFU_PROTECT_MPU_DMA2D_C, SFU_PROTECT_MPU_DMA2D_B
  },
  {
    SFU_PROTECT_MPU_MDMA_RGNV, SFU_PROTECT_MPU_MDMA_START, SFU_PROTECT_MPU_MDMA_SIZE,
    SFU_PROTECT_MPU_MDMA_PERM, SFU_PROTECT_MPU_MDMA_EXECV, SFU_PROTECT_MPU_MDMA_SREG,
    SFU_PROTECT_MPU_MDMA_TEXV, SFU_PROTECT_MPU_MDMA_C, SFU_PROTECT_MPU_MDMA_B
  },
  {
    SFU_PROTECT_MPU_BDMA_RGNV, SFU_PROTECT_MPU_BDMA_START, SFU_PROTECT_MPU_BDMA_SIZE,
    SFU_PROTECT_MPU_BDMA_PERM, SFU_PROTECT_MPU_BDMA_EXECV, SFU_PROTECT_MPU_BDMA_SREG,
    SFU_PROTECT_MPU_BDMA_TEXV, SFU_PROTECT_MPU_BDMA_C, SFU_PROTECT_MPU_BDMA_B
  }
};
#endif /* SFU_MPU_PROTECT_ENABLE */
