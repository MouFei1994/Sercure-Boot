...
@par Directory contents
   ...
   - 2_Images_UserApp/Src/stm32f4xx_it.c           Interrupt handlers
   - 2_Images_UserApp/Src/system_stm32f4xx.c       STM32 system file
   ...
   - 2_Images_UserApp/Inc/stm32f4xx_conf.h         HAL configuration file
   - 2_Images_UserApp/Inc/stm32f4xx_it.h           Header for stm32f4xx_it.c file
...
2. Pressing 2 allows to test protections.
 ...
 - MPU isolation tests (#1, #2): cause a reset trying to access protected code or data (either in RAM or FLASH)
 - PCROP test (#3): PCROP protection is not available on this board
 ...
 - TAMPER test (#6): causes a reset if a tamper event is detected. In order to generate a tamper event,
   user has to connect PC13 (CN8.8) to GND (It may be enough to put your finger close to PC13 (CN8.8)).
