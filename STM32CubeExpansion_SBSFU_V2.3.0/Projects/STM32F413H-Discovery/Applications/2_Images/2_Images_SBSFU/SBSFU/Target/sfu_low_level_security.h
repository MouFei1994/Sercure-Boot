...
/**
  * @brief Region 0 - Enable the read/write operations for full peripheral area (without bit banding region) in
  *                   unprivileged mode.
...
/**
  * @brief Region 1 - Enable the read/write operations for DMA peripheral area in privileged mode.
  *                   Execution capability disabled
  *                   Inner region inside the Region 0
  */
#define SFU_PROTECT_MPU_PERIPH_2_RGNV  MPU_REGION_NUMBER1
#define SFU_PROTECT_MPU_PERIPH_2_START DMA1_BASE
#define SFU_PROTECT_MPU_PERIPH_2_SIZE  MPU_REGION_SIZE_2KB
...
/**
  * @brief Region 0 - Enable the read/write operations for full peripheral area (bit banding area included) in
  *                   unprivileged mode.
  *                   Execution capability disabled
  */
#define APP_PROTECT_MPU_PERIPH_1_RGNV  MPU_REGION_NUMBER0
#define APP_PROTECT_MPU_PERIPH_1_START PERIPH_BASE         /*!< Peripheral memory area */
#define APP_PROTECT_MPU_PERIPH_1_SIZE  MPU_REGION_SIZE_512MB
#define APP_PROTECT_MPU_PERIPH_1_SREG  0x00U               /*!< All subregions activated */
...
/**
  * @brief Region 3 - Enable the execution for SBSFU and Slot#0 in unprivileged mode.
  *                   Read only capability configured
  *                   Inner region inside the Region 2
  */
...
#define APP_PROTECT_MPU_FLASHEXE_SREG  0x82U               /*!< subregion 0 (activated): SBSFU
                                                                ...
                                                                subregions 2,3,4,5,6 (activated) : Slot0 */
...
/**
  * @brief Region 4 - Enable the read/write operations for DMA (bit banding area) peripheral area in privileged mode.
  *                   Execution capability disabled
  *                   Inner region inside the Region 0
  *                   Reuse of Slot0 header region
  */
#define APP_PROTECT_MPU_DMABBA_RGNV  MPU_REGION_NUMBER4
#define APP_PROTECT_MPU_DMABBA_START (PERIPH_BB_BASE  + (DMA1_BASE - PERIPH_BASE) * 32 )
#define APP_PROTECT_MPU_DMABBA_SREG  0x00U                 /*!< All subregions activated */
#define APP_PROTECT_MPU_DMABBA_SIZE  MPU_REGION_SIZE_64KB
#define APP_PROTECT_MPU_DMABBA_PERM  MPU_REGION_PRIV_RW
#define APP_PROTECT_MPU_DMABBA_EXECV MPU_INSTRUCTION_ACCESS_DISABLE
#define APP_PROTECT_MPU_DMABBA_TEXV  MPU_TEX_LEVEL0
#define APP_PROTECT_MPU_DMABBA_B     MPU_ACCESS_NOT_BUFFERABLE
#define APP_PROTECT_MPU_DMABBA_C     MPU_ACCESS_CACHEABLE
